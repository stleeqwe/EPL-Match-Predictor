...
Enhanced with:
- Chain-of-Thought prompting (단계별 분석)
- Few-Shot Examples (수렴/조정 사례)
"""
...
def generate_phase3_prompt(
    ...
    """
    Phase 3 프롬프트 생성 (Enhanced with Prompt Engineering)
    ...
    Args:
        ...
        use_cot: Chain-of-Thought prompting 사용 여부
...
- 'status': 'needs_adjustment'로 설정"""
    ...
    if use_cot and PROMPT_ENGINEERING_AVAILABLE:
        try:
            user_prompt = CoTPromptTemplate.generate_analysis_cot_prompt(
    ...
    if include_examples and PROMPT_ENGINEERING_AVAILABLE:
        try:
